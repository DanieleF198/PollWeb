                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="text-align:center;">
                                                                <div class="row justify-content-center">
                                                                    <div class="row mr-3 mt-2">
                                                                        <div class="col-6 pl-1 pr-1">
                                                                            <form id="returnSurvey" action="survey" method="GET">
                                                                                <#if sondaggio.isModificabile()>
                                                                                    <button type="submit" name="returnSurvey" value="${sondaggio.getKey()}" class="btn brn-lg btn-warning" title="modifica risposta">
                                                                                <#else>
                                                                                    <button type="submit" name="returnSurvey" value="${sondaggio.getKey()}" class="btn brn-lg btn-warning" title="modifica risposta" disabled>    
                                                                                </#if>

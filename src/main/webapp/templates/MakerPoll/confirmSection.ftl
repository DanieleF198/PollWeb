                                            ...
                                            <tbody>
                                                <#list domande as domanda>  
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <#if domanda?is_first>
                                                                <button form="confirmForm" type="submit" name="goUpQuestion" value="goUpQuestionButton${domanda.getPosizione()}" class="btn btn-light mr-1 mb-1" title="Sposta in alto" disabled>
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-up-short" viewBox="0 0 16 16">
                                                                        <path fill-rule="evenodd" d="M8 12a.5.5 0 0 0 .5-.5V5.707l2.146 2.147a.5.5 0 0 0 .708-.708l-3-3a.5.5 0 0 0-.708 0l-3 3a.5.5 0 1 0 .708.708L7.5 5.707V11.5a.5.5 0 0 0 .5.5z"/>
                                                                    </svg>
                                                                </button>
                                                            <#else>
                                                                <button form="confirmForm" type="submit" name="goUpQuestion" value="goUpQuestionButton${domanda.getPosizione()}" class="btn btn-light mr-1 mb-1" title="Sposta in alto">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-up-short" viewBox="0 0 16 16">
                                                                        <path fill-rule="evenodd" d="M8 12a.5.5 0 0 0 .5-.5V5.707l2.146 2.147a.5.5 0 0 0 .708-.708l-3-3a.5.5 0 0 0-.708 0l-3 3a.5.5 0 1 0 .708.708L7.5 5.707V11.5a.5.5 0 0 0 .5.5z"/>
                                                                    </svg>
                                                                </button>
                                                            ...
                                                            <#if domanda?is_last>
                                                                <button form="confirmForm" type="submit" name="goDownQuestion" value="goDownQuestionButton${domanda.getPosizione()}" class="btn btn-light mr-1 mb-1" title="sposta in basso" disabled>
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down-short" viewBox="0 0 16 16">
                                                                      <path fill-rule="evenodd" d="M8 4a.5.5 0 0 1 .5.5v5.793l2.146-2.147a.5.5 0 0 1 .708.708l-3 3a.5.5 0 0 1-.708 0l-3-3a.5.5 0 1 1 .708-.708L7.5 10.293V4.5A.5.5 0 0 1 8 4z"/>
                                                                    </svg>
                                                                </button>
                                                            <#else>
                                                                <button form="confirmForm" type="submit" name="goDownQuestion" value="goDownQuestionButton${domanda.getPosizione()}" class="btn btn-light mr-1 mb-1" title="sposta in basso">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down-short" viewBox="0 0 16 16">
                                                                      <path fill-rule="evenodd" d="M8 4a.5.5 0 0 1 .5.5v5.793l2.146-2.147a.5.5 0 0 1 .708.708l-3 3a.5.5 0 0 1-.708 0l-3-3a.5.5 0 1 1 .708-.708L7.5 10.293V4.5A.5.5 0 0 1 8 4z"/>
                                                                    </svg>
                                                                </button>
                                                            </#if>
                                                            <button form="confirmForm" type="submit" name="removeQuestion" value="removeQuestionButton${domanda.getPosizione()}" class="btn btn-danger" title="elimina">
                                                    ...
                                                    <div id="fieldList" class="row mb-3">
                                                        <#list partecipants as partecipant>
                                                            <#if partecipant_has_next>
                                                                ...
                                                                <div class="col-lg-1 col-md-1 col-sx-1 col-1"></div>
                                                                <div class="col-12 border-bottom mb-2"></div>
                                                            <#else>
                                                                <#if partecipant.getNome()?? && partecipant.getNome()!="">
                                                                    <div class="col-lg-3 col-md-3 col-sx-12 col-12 mb-2">
                                                                        <input type="text" name="usersName[]" id="firstUserName" class="form-control" placeholder="Nome Utente" value="${partecipant.getNome()}"  disabled>
                                                                    </div>
                                                                <#else>
                                                                    <div class="col-lg-3 col-md-3 col-sx-12 col-12 mb-2">
                                                                        <input type="text" name="usersName[]" id="firstUserName" class="form-control" placeholder="Nome Utente"   disabled>
                                                                    </div>
                                                                </#if>
                                                                <#if partecipant.getEmail()?? && partecipant.getEmail()!="">
                                                                    <div class="col-lg-4 col-md-4 col-sx-12 col-12 mb-2">
                                                                        <input type="text" name="usersMail[]" id="firstUserMail" class="form-control" placeholder="E-mail utente" value="${partecipant.getEmail()}"  disabled>
                                                                    </div>
                                                                <#else>
                                                                    <div class="col-lg-4 col-md-4 col-sx-12 col-12 mb-2">
                                                                        <input type="text" name="usersMail[]" id="firstUserMail" class="form-control" placeholder="E-mail utente"   disabled>
                                                                    </div>
                                                                </#if>
                                                                <#if partecipant.getPassword()?? && partecipant.getPassword()!="">
                                                                    <div class="col-lg-4 col-md-4 col-sx-12 col-12 mb-2">
                                                                        <input type="text" name="usersPass[]" id="firstUserPass" class="form-control" placeholder="Password utente" value="${partecipant.getPassword()}"  disabled>
                                                                    </div>
                                                                <#else>
                                                                    <div class="col-lg-4 col-md-4 col-sx-12 col-12 mb-2">
                                                                        <input type="text" name="usersPass[]" id="firstUserPass" class="form-control" placeholder="Password utente"   disabled>
                                                                    </div>
                                                                </#if>
                                                                <div class="col-lg-1 col-md-1 col-sx-1 col-1"></div>
                                                                <div class="col-12 border-bottom mb-2"></div>
                                                    ...
                                                    <div id="fieldList" class="row mb-3">
                                                        <#list partecipants as partecipant>
                                                            ...
                                                            <#else>
                                                                ...
                                                                <#if partecipant.getEmail()?? && partecipant.getEmail()!="">
                                                                    <div class="col-lg-4 col-md-4 col-sx-12 col-12 mb-2">
                                                                        <input type="text" name="usersMail[]" id="firstUserMail" class="form-control" placeholder="E-mail utente" value="${partecipant.getEmail()}" >
                                                                    </div>
                                                                <#else>
                                                                    <div class="col-lg-4 col-md-4 col-sx-12 col-12 mb-2">
                                                                ...
                                                                <#if partecipant.getPassword()?? && partecipant.getPassword()!="">
                                                                    <div class="col-lg-4 col-md-4 col-sx-12 col-12 mb-2">
                                                                        <input type="text" name="usersPass[]" id="firstUserPass" class="form-control" placeholder="Password utente" value="${partecipant.getPassword()}" >
                                                                    </div>
                                                                <#else>
                                                                    <div class="col-lg-4 col-md-4 col-sx-12 col-12 mb-2">

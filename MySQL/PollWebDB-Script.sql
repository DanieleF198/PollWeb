...
INSERT INTO `pollwebdb`.`Sondaggio`(`idSondaggio`,`idUtente`,`titolo`,`testoApertura`,`testoChiusura`,`completo`,`visibilita`,`dataCreazione`,`dataChiusura`,`privato`,`modificabile`)VALUES('2','2','Prova 2', 'Hey questo è il secondo sondaggio di prova guardatemiiiii', 'Immagina aver concluso questo sondggio', true, true,'2021-02-11','2021-03-12',false,false);
INSERT INTO `pollwebdb`.`Sondaggio`(`idSondaggio`,`idUtente`,`titolo`,`testoApertura`,`testoChiusura`,`completo`,`visibilita`,`dataCreazione`,`dataChiusura`,`privato`,`modificabile`)VALUES('3','2','Prova 3', 'Hey questo è il terzo sondaggio di prova guardatemiiiii', 'Complimenti per aver conseguto la compilazione di questo sondaggio. I tuoi dati sono pronti per essere inviati a Google e alle industrie cinesi', true, true,'2021-03-11','2021-04-12',false,false);
INSERT INTO `pollwebdb`.`Sondaggio`(`idSondaggio`,`idUtente`,`titolo`,`testoApertura`,`testoChiusura`,`completo`,`visibilita`,`dataCreazione`,`dataChiusura`,`privato`,`modificabile`)VALUES('4','2','Prova 4', 'Hey questo è il quarto sondaggio di prova guardatemiiiii', 'La torta è una menzogna', true, true,'2021-04-11','2021-05-12',false,false);
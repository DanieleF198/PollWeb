...
INSERT INTO `pollwebdb`.`Utente`(`idUtente`,`idGruppo`,`nome`,`cognome`,`dataNascita`,`username`,`password`,`email`,`bloccato`)VALUES('4','2','Abdul', 'AbdulU', '1970-12-12', 'magitianU', 'red', 'MagitianU.Red@gmail.com',false);
...
INSERT INTO `pollwebdb`.`ListaPartecipanti`(`idListaPartecipanti`,`idUtente`,`idSondaggio`,`nome`,`email`,`password`,`scaduto`,`emailMandata`)VALUES('1', '1', '1', 'artrito', 'arturitoBenedito@gmail.com', 'Pass2021!',false,true);
...
INSERT INTO `pollwebdb`.`ListaPartecipanti`(`idListaPartecipanti`,`idUtente`,`idSondaggio`,`nome`,`email`,`password`,`scaduto`,`emailMandata`)VALUES('4', '2', '5', 'zawardo', 'dioBrando@gmail.com', 'mudamuda',false,true);
INSERT INTO `pollwebdb`.`ListaPartecipanti`(`idListaPartecipanti`,`idUtente`,`idSondaggio`,`nome`,`email`,`password`,`scaduto`,`emailMandata`)VALUES('5', '2', '6', 'zawardo', 'dioBrando@gmail.com', 'mudamuda',false,true);
...
INSERT INTO `pollwebdb`.`ListaPartecipanti`(`idListaPartecipanti`,`idUtente`,`idSondaggio`,`nome`,`email`,`password`,`scaduto`,`emailMandata`)VALUES('7', '2', '11', 'zawardo', 'dioBrando@gmail.com', 'mudamuda',false,true);
INSERT INTO `pollwebdb`.`ListaPartecipanti`(`idListaPartecipanti`,`idUtente`,`idSondaggio`,`nome`,`email`,`password`,`scaduto`,`emailMandata`)VALUES('8', '2', '12', 'zawardo', 'dioBrando@gmail.com', 'mudamuda',false,true);
INSERT INTO `pollwebdb`.`ListaPartecipanti`(`idListaPartecipanti`,`idUtente`,`idSondaggio`,`nome`,`email`,`password`,`scaduto`,`emailMandata`)VALUES('9', '2', '16', 'zawardo', 'dioBrando@gmail.com', 'mudamuda',false,true);
INSERT INTO `pollwebdb`.`ListaPartecipanti`(`idListaPartecipanti`,`idUtente`,`idSondaggio`,`nome`,`email`,`password`,`scaduto`,`emailMandata`)VALUES('10', '2', '18', 'zawardo', 'dioBrando@gmail.com', 'mudamuda',false,true);
INSERT INTO `pollwebdb`.`ListaPartecipanti`(`idListaPartecipanti`,`idUtente`,`idSondaggio`,`nome`,`email`,`password`,`scaduto`,`emailMandata`)VALUES('11', '2', '21', 'zawardo', 'dioBrando@gmail.com', 'mudamuda',false,true);
